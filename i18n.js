...
const translations = {
  en: {
    ...
    index_card1_desc:
      "We actively analyze widespread software, enterprise platforms, and critical infrastructure to unearth zero-day vulnerabilities and report them responsibly.",
    index_card2_title: "Red Teaming",
    index_card2_desc:
      "Simulating advanced persistent threats (APT) to test and improve organizational detection and response capabilities.",
    index_card3_title: "Security Tooling",
    index_card3_desc:
      "Building open-source offensive security tools to automate exploitation and payload generation, aiding the research community.",
    ...
    cve_hero_desc:
      "Research findings identifying vulnerabilities discovered in a zero-day state within latest stable releases, responsibly disclosed to maintainers for subsequent patching and CVE assignment.",
    ...
    cve_multi_summary:
      "Stack overflow vulnerability in the IOCTL handler of a kernel driver commonly used by multiple hardware vendors. Allows arbitrary code execution with kernel privileges.",
    cve_label_collab: "Colleagues",
    cve1_title:
      "Path Traversal in Official Example Script Leading to Arbitrary File Write",
    cve1_summary_label: "Summary:",
    cve1_summary:
      "The official example script examples/recursively_extract_attachments.py contains a path traversal vulnerability that allows arbitrary file write outside the intended output directory.",
    ...
    cve2_impact:
      "A flaw in token validation allowed attackers to forge sessions and escalate privileges to administrative accounts without valid credentials.",
    ...
    research_hero_desc:
      "Deep dives into exploitation techniques, reverse engineering, and offensive methodology.",
    research_card1_tag: "Article",
    research_card1_title: "Bypassing Modern EDRs with Custom Syscalls",
    research_card1_desc:
      "An exploration of direct system calls and how to evade API hooking dynamically while maintaining stability in payloads.",
    research_card1_date: "March 2026",
    research_card2_tag: "Writeup",
    research_card2_title: "Analysis of the UploadServer RCE",
    research_card2_desc:
      "Detailed breakdown of how we achieved remote code execution by chaining vulnerabilities in the Python UploadServer module.",
    ...
    team_hero_desc:
      "We are a group of dedicated security engineers and researchers united by a passion for offensive security.",
    team_role: "Co-Founder",
    team_desc:
      "Specializes in Web Security, Cloud Architecture, and APT Simulation.",
  },
  ko: {
    // Nav
    nav_home: "홈",
    ...
    index_hero_desc:
      "RedPoc은 취약점 발굴, 레드팀 활동, 그리고 사이버보안의 한계를 넓히는 데 집중하는 오펜시브 보안 연구팀입니다.",
    index_btn_cve: "CVE 확인하기",
    index_btn_research: "연구 보기",
    index_section_title: "핵심 분야",
    index_card1_title: "0-Day 발굴",
    index_card1_desc:
      "광범위하게 사용되는 소프트웨어, 기업 플랫폼, 핵심 인프라를 능동적으로 분석하여 제로데이 취약점을 발굴하고 책임감 있게 보고합니다.",
    index_card2_title: "레드팀 활동",
    index_card2_desc:
      "고급 지속 위협(APT)을 시뮬레이션하여 조직의 탐지 및 대응 역량을 테스트하고 개선합니다.",
    index_card3_title: "보안 도구 개발",
    index_card3_desc:
      "익스플로잇 자동화 및 페이로드 생성을 위한 오픈소스 오펜시브 보안 도구를 개발하여 연구 커뮤니티를 지원합니다.",
    ...
    cve_hero_desc:
      "최신 안정 버전에서 발견 당시 제로데이(0-Day) 상태였던 취약점들을 식별하고, 책임감 있는 제보를 통해 패치와 CVE 할당을 이끌어낸 연구 기록입니다.",
    cve_tab_cve: "CVE 트랙",
    ...
    cve_multi_summary:
      "다수의 하드웨어 벤더에서 공통으로 사용되는 커널 드라이버의 IOCTL 핸들러에서 발견된 스택 오버플로우 취약점입니다. 공격자는 이를 통해 커널 권한으로 임의 코드를 실행할 수 있습니다.",
    cve_label_collab: "공동 연구",
    cve1_title: "공식 예제 스크립트 경로 탐색 취약점",
    cve1_summary_label: "요약:",
    cve1_summary:
      "recursively_extract_attachments.py 파일 내 경로 검증 루틴 부재로 인해 임의 경로 파일 쓰기가 가능한 취약점입니다.",
    cve1_target: "Python 예제",
    cve1_btn: "NVD 어드바이저리",
    cve2_title: "엔터프라이즈 플랫폼 인증 우회",
    cve2_impact_label: "영향:",
    cve2_impact:
      "사용자 세션 토큰 검증 로직의 결함을 이용하여 별도의 비밀번호 없이 관리자 계정 권한을 탈취할 수 있는 취약점입니다.",
    cve2_target: "기업용 CMS",
    cve2_btn: "상세보기",
    ...
    team_hero_desc:
      "오펜시브 보안에 대한 열정으로 뭉친 보안 엔지니어 및 연구자들의 그룹입니다.",
    team_role: "공동 창립자",
